  ...
  return (
    <section id="features" className={layout.section}>
      <div className={`${layout.sectionInfo} p-3  rounded-[20px] `}>
        <h2
          className={`${styles.heading2} text-white text-[25px] sm:text-[40px] mt-5 bg-[#2ea193] rounded-lg  text-center`}
        >
          Investment
        </h2>
        <div className="flex justify-between sm:mt-40 gap-1 sm:justify-around sm:gap-5 ">
          ...
          <input
            type="text"
            class="  w-[40%] h-[40%] mt-5 mr-0 px-1.5 py-1.5 text-base font-normal text-black bg-white  bg-clip-padding  text-center border-[3px] border-solid border-[#2ea193]  rounded transition ease-in-out m-0   "
      ...
      <div className={`${layout.sectionInfo} p-3 rounded-[20px] `}>
        <h2 className={`${styles.heading2}  text-white text-[30px] sm:text-[40px] mt-5 bg-[#2ea193] rounded-lg  text-center`}>Rewards</h2>
        ...
        <div className="flex justify-between gap-5 mt-4">
          <Button
            styles={` w-[40%] text-[14px] sm:text-[18px] bg-[#2ea193]`}
            title={"Reinvest"}
          />
          <input
            type="text"
        ...
        <Button
          styles={`mt-5  sm:w-[40%] text-[15px] bg-[#2ea193]`}
