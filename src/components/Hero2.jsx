...
import { Blue, Blue2, Blue3, discount, lionLogo, robot } from "../assets";
  ...
  return (
    <div id="home" className=" text-align: center py-30 md:flex-row">
      ...
      <div className="flex justify-center py-5">
        <p
          className={`font-poppins font-normal text-[#2ea193] text-[30px] sm:text-[40px] sm:justify-center leading-[30.8px]  mt-5`}
        >
          WELCOME TO LIONS
        </p>
      </div>
      ...
      <div className="flex justify-center   ">
        <Button
          styles={`mt-7 sm:w-[60%] text-[20px] sm:text-[40px] mt-5 bg-[#2ea193] rounded-lg  text-center w-[87.5%]`}
